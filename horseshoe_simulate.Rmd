...
```{r}
set.seed(2020)
name = "horseshoe_nonlinear_heterogeneous_500.csv"
n_rep = 50
results = replicate(n_rep, simulate_once(500, "heterogeneous", "nonlinear", 1.0), simplify = "matrix")
colnames(results) <- paste0("Sim", 1:n_rep)
results_df = as.data.frame(t(results))
write.csv(results_df, name, row.names = FALSE)
```
